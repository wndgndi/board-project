...
import com.fastcampus.newboardproject.config.TestSecurityConfig;
...
import com.fastcampus.newboardproject.util.FormDataEncoder;
...
class ArticleControllerTest {
    ...
    @WithUserDetails(value = "wndgnTest", setupBefore = TestExecutionEvent.TEST_EXECUTION)
